...
de2en
src=/de2enout_rnn/data/de2en.dev.en.bpe.txt
tst=/de2enout_rnn/dev/w<i>.pred.bpe
'''
import sys
import os
...
def APAL_from_file(file_src, dir_tgt, type_dataset, type_bpe, model='trans', is_clean=False, is_weight_ave=False, metric='AP'):
    ...
    title_base = 'de2en_{}_scatter_{}_{}'.format(model, type_dataset, metric)
...
def plot_all(src, tgt_dir, type_dataset, model="trans", type_bpe=True, metric='AP'):
    ...
    fig.savefig('{}/de2en_{}_{}_{}.pdf'.format(model, model, type_dataset, metric))
    f = open('{}/de2en_{}_{}_{}.txt'.format(model, model, type_dataset, metric), 'w')
    print('{}/de2en_{}_{}_{}.txt'.format(model, model, type_dataset, metric))
