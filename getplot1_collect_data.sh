...
# dev/test pred
scp -r kaibo@asimov-0-log.svail.baidu.com:/mnt/scratch/kaibo/proj/fordecoding_catchup/decode_result$1 ./catchup
scp -r kaibo@asimov-0-log.svail.baidu.com:/mnt/scratch/kaibo/proj/fordecoding/decode_result$1 ./waitk
# dev/test ref
